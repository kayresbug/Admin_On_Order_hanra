...
public class CalculateFragment extends Fragment {
    ...
    TextView txtTotalPrice, txtTotalReturnSale, txtTotalSales, txtTotalDiscount, txtActualSales, txtTaxSale,
            ...
            txtAffiliateCard, txtMilelege, txtMealTicket, txtOther, txtTotal;
...
//        });
        ...
        txtTotal = view.findViewById(R.id.calc_total);
        ...
        interfaceAPI.sellPayment(storeCode, paymentTimeFrom, paymentTimeTo).enqueue(new Callback<JsonObject>() {
            ...
            public void onResponse(Call<JsonObject> call, Response<JsonObject> response) {
                if (response.isSuccessful()) {
                    ...
                    Log.d("daon_test", "sellpayment = "+object.toString());
...
//                            String strPrice = decimalFormat.format(Integer.parseInt(subPrice));
                            if (strObj.get("cardno").equals("Cash")){
                                totalCash = totalCash +Integer.parseInt((String) strObj.get("price"));
                            }
                            if (strObj.get("cardno").equals("nCash")){
                                totalnCash = totalnCash +Integer.parseInt((String) strObj.get("price"));
                            }
                            if (String.valueOf(strObj.get("cardno")).length() > 10){
                                totalCard = totalCard +Integer.parseInt((String) strObj.get("price"));
                            }
                ...
                Log.d("daon_test", "total = "+totalCash);
                setLayout();
    ...
    public void setLayout(){
        txtCash.setText(String.valueOf(totalCash - totalnCash));
        txtCredit.setText(String.valueOf(totalCard));
        txtTotal.setText(String.valueOf(totalCard+totalCash - totalnCash));
        txtTotalReturnSale.setText(String.valueOf(totalnCash));
        txtTotalPrice.setText(String.valueOf(totalCard+totalCash));
        txtNetSales.setText(String.valueOf(totalCard+totalCash - totalnCash));
